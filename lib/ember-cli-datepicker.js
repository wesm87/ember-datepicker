...
EmberCLIDatepicker.prototype.included = function included(app) {
  ...
  this.app.import('bower_components/ember-cli-datepicker/js/moment.js');
  this.app.import('bower_components/ember-cli-datepicker/js/pikaday.js');
  this.app.import('bower_components/ember-cli-datepicker/styles/pikaday.css');
};
